...
```
docker build  -t sequenceiq/hadoop-docker:2.7.4 .
```
# Pull the image
...
```
docker pull sequenceiq/hadoop-docker:2.7.4
```
...
```
docker run -it sequenceiq/hadoop-docker:2.7.4 /etc/bootstrap.sh -bash
```
